section .data
    ...
    int_format db "%d", 0                 ; Format for printing integers
...
input_loop:
    ...
    ; Debugging: Print the integers entered
    mov eax, 4                            ; sys_write
    mov ebx, 1                            ; File descriptor (stdout)
    ...
    ; Print the integers entered
    lea ebx, [array]                      ; Address of the array
    mov ecx, 5                            ; Loop counter for output
...
output_reversed_loop:
    ...
    add ebx, 4                            ; Move to next integer in the array
    loop output_reversed_loop             ; Repeat for all integers
