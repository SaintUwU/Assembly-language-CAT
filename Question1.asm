...
convert_to_int:
    ...
    ; Adjust for negative numbers if the sign was set
    cmp ebx, 0                          ; If the sign flag is zero, no change needed
    je classify                          ; Otherwise, negate the number
    neg eax                              ; Negate the result in eax
